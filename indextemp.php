  ...
  <main>
    ...
    <div class="container">
      ...
      <div class="room-description">
        ...
        <h2>Room Details</h2>
        <p>Number of Bedrooms:<strong>1 BHK Flat</strong></p>
        <p>Cost:<strong>₹11000 per month</strong></p>
        <p>Address:<strong>Model Town Yamuna Nagar, Pune, Maharashtra , India</strong></p>
        <a href="room7.html">Ready to Move</a>
      </div>
    </div>
    ...
    <div class="container">
      <div class="room-picture">
        ...
        <div class="wishlist"><i class="heart-icon fas fa-heart" onclick="toggleHeartIcon(this)"></i></div>
        <img src="room2.png" alt="Room Picture" width="500px" height="300px">
      </div>

      <div class="room-description">
        <div class="discount-tag"> No Offer!</div>
        <h2>Room Details</h2>
        <p>Number of Bedrooms:<strong>1 Single Room</strong></p>
        <p>Cost:<strong>₹4000 per month</strong></p>
        <p>Address:<strong>Vidarbha Heights, Civil Lines, Nagpur, Maharashtra, India</strong></p>
        <a href="room9.html">Ready to Move</a>
      </div>
    </div>
    ...
    <div class="container">
      <div class="room-picture">
        ...
        <div class="wishlist"><i class="heart-icon fas fa-heart" onclick="toggleHeartIcon(this)"></i></div>
        <img src="room4.png" alt="Room Picture" width="500px" height="300px">
      </div>

      <div class="room-description" for="abcd">
        <div class="discount-tag">10% OFF!</div>
        <h2>Room Details</h2>
        <p>Number of Bedrooms:<strong>2 Rooms</strong></p>
        <p>Cost:<strong>₹8000 per month</strong></p>
        <p>Address:<strong>Silver Oak Enclave, Malad West, Mumbai, Maharashtra, India</strong></p>
        <a href="room1.html">Ready to Move</a>
      </div>
    </div>
    ...
    <div class="container">
      <div class="room-picture">
        ...
        <div class="wishlist"><i class="heart-icon fas fa-heart" onclick="toggleHeartIcon(this)"></i></div>
        <img src="R7.png" alt="Room Picture" width="500px" height="300px">
      </div>

      <div class="room-description">
        <div class="discount-tag">50% OFF!</div>
        <h2>Room Details</h2>
        <p>Number of Bedrooms:<strong>2 BHK Flat</strong></p>
        <p>Cost:<strong>₹20000 per month</strong></p>
        <p>Address:<strong>Serene Heights, Rajapeth, Amravati, Maharashtra, India</strong></p>
        <a href="room2.html">Ready to Move</a>
      </div>
    </div>
    ...
    <div class="container">
      <div class="room-picture">
        ...
        <div class="wishlist"><i class="heart-icon fas fa-heart" onclick="toggleHeartIcon(this)"></i></div>
        <img src="room11.png" alt="Room Picture" width="500px" height="300px">
      </div>

      <div class="room-description">
        <div class="discount-tag">30% OFF!</div>
        <h2>Room Details</h2>
        <p>Number of Bedrooms:<strong>3 BHK Flat</strong></p>
        <p>Cost:<strong>₹25000 per month</strong></p>
        <p>Address:<strong>Tiger Square Towers, Sitabuldi, Nagpur, Maharashtra, India</strong></p>
        <a href="#room3.html">Ready to Move</a>
      </div>
    </div>
    ...
    <div class="container">
      <div class="room-picture">
        ...
        <div class="wishlist"><i class="heart-icon fas fa-heart" onclick="toggleHeartIcon(this)"></i></div>
        <img src="R3.png" alt="Room Picture" width="500px" height="300px">
      </div>
      ...
      <div class="room-description">
        ...
        <h2>Room Details</h2>
        <p>Number of Bedrooms:<strong>2 BHK Flat</strong></p>
        <p>Cost:<strong>₹15000 per month</strong></p>
        <p>Address:<strong>456 Park View Society, Koregaon Park, Pune, Maharashtra, India</strong></p>
        <a href="room4.html">Ready to Move</a>
      </div>
    </div>
    ...
    <div class="container">
      <div class="room-picture">
        ...
        <div class="wishlist"><i class="heart-icon fas fa-heart" onclick="toggleHeartIcon(this)"></i></div>
        <img src="room6.png" alt="Room Picture" width="500px" height="300px">
      </div>
      ...
      <div class="room-description">
        ...
        <h2>Room Details</h2>
        <p>Number of Bedrooms:<strong>1 Single Room</strong></p>
        <p>Cost:<strong>₹5000 per month</strong></p>
        <p>Address:<strong>Sea View Apartments, Bandra West, Mumbai, Maharashtra, India</strong></p>
        <a href="room5.html">Ready to Move</a>
      </div>
    </div>
    ...
    <div class="container">
      <div class="room-picture">
        ...
        <div class="wishlist"><i class="heart-icon fas fa-heart" onclick="toggleHeartIcon(this)"></i></div>
        <img src="R1.png" alt="Room Picture" width="500px" height="300px">
      </div>

      <div class="room-description">
        <div class="discount-tag">No Offer!</div>
        <h2>Room Details</h2>
        <p>Number of Bedrooms:<strong>Double Room</strong></p>
        <p>Cost:<strong>₹7000 per month</strong></p>
        <p>Address:<strong>Lotus Towers, Camp, Pune, Maharashtra, India</strong></p>
        <a href="room6.html">Ready to Move</a>
      </div>
    </div>
  </main>
