            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="dashboard.php" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">Urban Nest</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" validate action="session.php" method="POST">
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" name="upassword" class="form-control" id="yourPassword" required>
